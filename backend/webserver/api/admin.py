...
create_user.add_argument('is_admin', type=bool, default=False, location='json')
create_user.add_argument('is_vtcc', type=bool, default=False, location='json')
...
register.add_argument('isVtcc', type=bool, default=False, location='json')
...
class User(Resource):
    ...
    def post(self):
        ...
        user.is_vtcc = args.get('isVtcc', False)
        user.save()
...
class Username(Resource):
    ...
    def patch(self, username):
        ...
        is_vtcc = args.get('is_vtcc', False)
