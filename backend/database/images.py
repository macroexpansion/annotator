...
class ImageModel(DynamicDocument):
    ...
    user_category_ids = DictField(default={})
    ...
    def create_from_path(cls, path, dataset_id=None):
        ...
        image.regenerate_thumbnail = False
