  ...
  <div @mouseenter="onMouseEnter" @mouseleave="onMouseLeave">
    ...
    >
      <div @click="isVisible = !isVisible">
        <i
          v-if="isVisible"
          class="hover-btn fa fa-lg fa-eye annotation-icon"
          :style="{ padding: '0 1px 0 34px', color: color }"
        />
        <i
          v-else
          class="hover-btn fa fa-lg fa-eye-slash annotation-icon"
          style="float: left; padding: 0 1px 0 34px; color: white"
        />
      </div>

      <button
        class="btn btn-primary btn-link collapsed text-left annotation-text"
        :style="{
      ...
      <div style="float: right">
        <i
          ...
          class="fa fa-lg fa-gear annotation-icon"
          data-toggle="modal"
        ...
        <i
          ...
          class="fa fa-lg fa-trash-o annotation-icon"
        />
      </div>
    </div>
    ...
    >
      <li
        v-for="(kp, idx) in keypointListView"
        :key="idx"
      ...
      >
        ...
        <a
          @click="onAnnotationKeypointClick(idx)"
          :style="{
            float: 'left',
            width: '70%',
            color: 'white',
        ...
        <i
          ...
          @click="onAnnotationKeypointSettingsClick(idx)"
        ...
        <i
          v-if="kp.visibility !== 0"
          @click="onDeleteKeypointClick(idx)"
...
export default {
  ...
  methods: {
    ...
    deleteAnnotation() {
      axios.delete("/tagging/api/annotation/" + this.annotation.id).then(() => {
    ...
    simplifyPath() {
      ...
      this.compoundPath.fullySelected = this.isCurrent; // show segments
  ...
  computed: {
    ...
    backgroundColor() {
      ...
      if (this.isCurrent) return "#46624c";
