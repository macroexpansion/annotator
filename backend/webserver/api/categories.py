...
create_category.add_argument('subcategory', type=list, default=[], location='json')
create_category.add_argument('color', location='json')
create_category.add_argument('metadata', type=dict, location='json')
create_category.add_argument('classified', type=bool, location='json')
create_category.add_argument('group', location='json')
create_category.add_argument('project_id', location='json', type=int)
...
update_category.add_argument('classified', type=bool, location='json')
update_category.add_argument('supercategory', location='json')
update_category.add_argument('subcategory', type=list, default=[], location='json')
update_category.add_argument('color', location='json')
update_category.add_argument('metadata', type=dict, location='json')
update_category.add_argument('group', location='json')
...
page_data.add_argument('project_id', type=int)
...
class Category(Resource):
    ...
    def put(self, category_id):
        ...
        classified = args.get('classified', category.classified)
        group = args.get('group', 'Labeling')
        ...
        #     and category.color == color \
            ...
            # and category.classified == classified:
...
class Categories(Resource):
    ...
    def get(self):
        ...
        categories = current_user.categories.filter(project_id=project_id, deleted=False)
        pagination = Pagination(categories.count(), limit, page)
